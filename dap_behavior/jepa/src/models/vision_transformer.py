...
from dap_behavior.jepa.src.models.utils.patch_embed import PatchEmbed, PatchEmbed3D
...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        Args:
        uniform_power: bool
            whether to uniformily distribute the embedding dimension on width, height and depth,
            when calculating the positional encoding. 
        """
        super().__init__()
