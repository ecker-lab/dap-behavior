...
from dap_behavior.jepa.src.models.utils.modules import Block
from dap_behavior.jepa.src.models.utils.pos_embs import get_2d_sincos_pos_embed, get_3d_sincos_pos_embed
from dap_behavior.jepa.src.utils.tensors import (
    trunc_normal_,
...
class VisionTransformerPredictor(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if use_mask_tokens: # Felix: usually set to true in final version
    ...
    def forward(self, ctxt, tgt, masks_ctxt, masks_tgt, mask_index=1):
        ...
        :param tgt: target tokens (this is not used in the final version, just for some legacy diffusion experiments)
